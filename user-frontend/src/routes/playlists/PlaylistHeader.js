        ...
        <header className="playlist-header">
            ...
            <div className="playlist-header__infosection">
                <div className="playlist-header__text-box">
                    <h2>{props.title}</h2>
                    <h4 className="text-box__description">{props.description? props.description : "Beschreibungstext der die Playlist, ihren Inhalt und so weiter beschreibt"}</h4>
                </div>
                <div className="playlist-header__stats">
                    <div className="stats-box__stat stats-box__stat--video">
                        <Videocam />
                        <small>Videos</small>
                        <h5 className="stats-box__stat-value">{props.totalVideos ? props.totalVideos : "-"}</h5>
                    </div>
                    <div className="stats-box__stat stats-box__stat--duration">
                        <Timelapse />
                        <small>Gesamtlänge</small>
                        <h5 className="stats-box__stat-value">{props.totalDuration ? props.totalDuration : "-"}</h5>
                    </div>
                    <div className="stats-box__stat stats-box__stat--top-tags">
                        ...
                        <h5 className="stats-box__stat-value">{props.TopTags ? props.TopTags : "-"}</h5>
                    </div>
                    <div className="stats-box__stat stats-box__stat--channel">
                        ...
                        {
                            props.channelLink?
                            <Link className="button-text stats-box__stat-value" to={props.channelLink}>{props.Channel ? props.Channel : "Test Text"}</Link>
                            :
