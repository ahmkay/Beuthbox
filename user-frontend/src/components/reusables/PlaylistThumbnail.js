...
const PlaylistThumbnail = ({ playlistData }) => {
  ...
  return (
    <div className="playlist-thumbnail-container">
      <Link
        ...
        className="playlist-thumbnail-container__content"
      >
        <img
          src={
          ...
          className="playlist-thumbnail-container__thumbnail-img"
          alt="playlist thumbnail"
        />
        <img
          src={ButtonPlaylist}
          className="playlist-thumbnail-container__playlist-button"
          alt="playlist button"
        />
        <div className="playlist-thumbnail-container__overlay">
          <h5 className="playlist-thumbnail-container__playlist-title">
            {playlistData.name ? playlistData.name : "Kein Titel"}
          </h5>
          <div className="playlist-thumbnail-container__details">
            ...
            <div className="playlist-container__attributes-row">
              <h5 className="playlist-thumbnail-container__videocount">
                <Videocam /> {videoCount > 0 ? videoCount : "-"}
              </h5>
