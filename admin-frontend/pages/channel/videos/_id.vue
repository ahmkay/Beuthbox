                      ...
                      <v-flex xs6 class="pa-1">
                        ...
                        <v-layout row wrap>
                          <v-flex xs6 class="pr-1">
                            <v-select :items="accessSelectNoPublic" v-model="video.access" label="Access" v-if="currentChannel && currentChannel.videosOnlyPrivate" class="input-group--text-field-box" name="access"></v-select>
                            <v-select :items="accessSelect" v-model="video.access" label="Access" v-else name="access" class="input-group--text-field-box"></v-select>
                          </v-flex>
...
<script>
  ...
  export default {
    ...
    methods: {
      test() {
        console.log(typeof this.video.blas);
